...
// Module-scope — not recreated on every render
          ...
          <div className="bg-white dark:bg-slate-950 rounded-[30px] p-8 md:p-14 h-full w-full relative overflow-hidden">
            ...
            >
              ...
              <div className="xl:col-span-7 flex flex-col gap-10">
                <motion.div variants={itemVariants}>
                  <h3 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-4 leading-tight">
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 block sm:inline mt-2 sm:mt-0">
                      Enterprise Workforce Tracking Platform
                    </span>
                  </h3>
                ...
                >
                  Built a centralized workforce tracking platform to replace
                  fragmented third-party tools. Designed scalable backend
                  architecture and integrated it with a modern React dashboard
                  to deliver real-time visibility into remote employee
                  productivity.
                </motion.p>
                ...
                <div className="space-y-8 mt-2">
                  <motion.div variants={itemVariants} className="flex gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-400 text-base leading-relaxed">
                        Organizations relied on multiple third-party tools,
                        resulting in poor visibility, communication gaps, and
                        inefficient workforce tracking.
                      </p>
                    </div>
                  </motion.div>
                  ...
                  <motion.div variants={itemVariants} className="flex gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-400 text-base leading-relaxed">
                        Developed a unified platform using Liferay Service
                        Builder and REST APIs. Designed core entities like Work
                        Logs, Departments, and Notifications, enabling secure,
                        scalable, and real-time tracking.
                      </p>
                    </div>
                  </motion.div>
                </div>
