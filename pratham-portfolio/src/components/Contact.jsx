...
const Contact = () => {
  return (
    <section id="contact" className="py-32 relative overflow-hidden">
      ...
      <div className="absolute inset-0 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-indigo-600/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <div className="hidden sm:block w-px h-12 bg-slate-300 dark:bg-slate-800"></div>
